...
@pytest.mark.latex
def test_full_table_defaults_image_snapshot(table_defaults, tmp_path):
    require_tex_engine()
...
@pytest.mark.latex
def test_header_only_image_snapshot(table_defaults, tmp_path):
    require_tex_engine()
...
@pytest.mark.latex
def test_body_only_image_snapshot(table_defaults, tmp_path):
    require_tex_engine()
...
@pytest.mark.latex
def test_include_index_image_snapshot(table_plain, tmp_path):
    require_tex_engine()
...
@pytest.mark.latex
def test_header_groups_image_snapshot(table_plain, tmp_path):
    require_tex_engine()
...
@pytest.mark.latex
def test_row_highlight_image_snapshot(table_plain, tmp_path):
    require_tex_engine()
...
@pytest.mark.latex
def test_simple_string_formatter_snapshot(table_plain, tmp_path):
    require_tex_engine()
...
@pytest.mark.latex
def test_multiple_highlights_one_row(table_plain, tmp_path):
    require_tex_engine()
...
@pytest.mark.latex
def test_grouped_headers(table_defaults, tmp_path):
    require_tex_engine()
...
@pytest.mark.latex
def test_several_highlight_rows_and_grouped_headers(table_defaults, tmp_path):
    require_tex_engine()
...
@pytest.mark.latex
def test_gradient_command_image_snapshot(table_plain, tmp_path):
    require_tex_engine()
...
@pytest.mark.latex
def test_twocolor_gradient_command_image_snapshot(table_plain, tmp_path):
    require_tex_engine()
...
@pytest.mark.latex
def test_diverging_gradient_command_image_snapshot(table_plain, tmp_path):
    require_tex_engine()
...
def test_simple_highlight_snapshot(
    table_plain, tmp_path, highlight_func, name_suffix, colortype, color
):
    require_tex_engine()
...
@pytest.mark.latex
def test_highlight_between_exclude_bounds_snapshot(df, table_plain, tmp_path):
    require_tex_engine()
...
@pytest.mark.latex
def test_simple_highlight_ge_with_round_snapshot(table_plain, tmp_path):
    require_tex_engine()
...
@pytest.mark.latex
def test_many_rules(table_defaults, tmp_path):
    require_tex_engine()
