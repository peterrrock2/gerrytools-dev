...
def test_column_format_basic_no_boundary_extras():
    opts = TableOptions(
...
def test_column_format_with_boundary_extras_and_vrules():
    opts = TableOptions(
...
def test_column_format_bad_boundary_extras_length_raises():
    opts = TableOptions(
...
def test_multicolumn_format_mode_a_simple_no_index():
    opts = TableOptions(
...
def test_multicolumn_format_mode_a_with_index():
    opts = TableOptions(
        include_index=True,
        index_alignment="l",
        tabular_alignments=["l"],
...
def test_multicolumn_format_mode_a_bold_and_italic_group_headers():
    opts = TableOptions(
        tabular_alignments=["l"],
        vrule_counts=[0, 0],
...
def test_multicolumn_format_mode_a_no_bold_no_italic():
    opts = TableOptions(
        tabular_alignments=["l"],
        vrule_counts=[0, 0],
        groups_to_cols={"Group1": ["c1"]},
...
def test_multicolumn_format_mode_a_span_zero_group_is_skipped():
    opts = TableOptions(
        tabular_alignments=["l"],
        vrule_counts=[0, 0],
...
def test_multicolumn_format_mode_a_italic_only_group_headers():
    opts = TableOptions(
        tabular_alignments=["l"],
        vrule_counts=[0, 0],
        groups_to_cols={"Group1": ["c1"]},
...
def test_multicolumn_format_mode_a_partial_group_preamble_raises():
    opts = TableOptions(
        tabular_alignments=["l"],
        vrule_counts=[0, 0],
        groups_to_cols={"Group1": ["col1"]},
...
def test_multicolumn_format_mode_a_group_vrules_bad_length_raises():
    opts = TableOptions(
        tabular_alignments=["l"],
        vrule_counts=[0, 0],
        groups_to_cols={"Group1": ["col1"]},
...
def test_multicolumn_format_mode_a_group_boundary_extras_bad_length_raises():
    opts = TableOptions(
        tabular_alignments=["l"],
        vrule_counts=[0, 0],
        groups_to_cols={"Group1": ["col1"]},
...
def test_multicolumn_format_mode_a_group_header_cell_count_mismatch_raises():
    opts = TableOptions(
...
def test_multicolumn_format_mode_b_simple_no_index():
    opts = TableOptions(
        tabular_alignments=["l", "c", "r"],
...
def test_multicolumn_format_mode_b_italic_only_group_headers():
    opts = TableOptions(
...
def test_multicolumn_format_mode_b_bold_and_italic_group_headers():
    opts = TableOptions(
        tabular_alignments=["c"],
        vrule_counts=[0, 0],
        groups_to_cols={"Group1": ["c1"]},
...
def test_multicolumn_format_mode_b_span_zero_group_is_skipped():
    opts = TableOptions(
        tabular_alignments=["l"],
        vrule_counts=[0, 0],
...
def test_multicolumn_format_mode_b_vrules_bad_length_raises():
    opts = TableOptions(
