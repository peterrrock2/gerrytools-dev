...
.. image:: making_plots%20copy_files/making_plots%20copy_6_0.png
...
.. image:: making_plots%20copy_files/making_plots%20copy_7_0.png
...
.. image:: making_plots%20copy_files/making_plots%20copy_8_0.png
...
.. image:: making_plots%20copy_files/making_plots%20copy_9_0.png
...
.. image:: making_plots%20copy_files/making_plots%20copy_12_0.png
...
.. image:: making_plots%20copy_files/making_plots%20copy_13_0.png
...
.. image:: making_plots%20copy_files/making_plots%20copy_14_0.png
...
.. code:: ipython3
    ...
    dist = BoxPlot(include_legend=False, boxplot_group_width=0.7, boxplot_width_scale=0.8, xlabel="thing $\sigma$", ylabel="yhing", title="My Boxplot")
    ...
    dist.set_xaxis_label_style(
        fontsize=16,
        fontweight='bold',
        fontfamily="serif",
        fontcolor="teal!50"
    )
    dist.set_yaxis_label_style(
        fontsize=12,
        fontcolor="cadmiumgreen",
        fontstyle="italic"
    )
...
.. code:: ipython3
    ...
    dist.add_boxplot_datasets(make_boxplot_set(0.00), name="Ensemble", facecolor="alizarin", percentiles=(1, 99), edgewidth=2)
    dist.add_boxplot_datasets(make_boxplot_set(0.05), name="Citizen",  facecolor="#f58518", percentiles=(1, 99))
...
.. image:: making_plots%20copy_files/making_plots%20copy_19_0.png


.. code:: ipython3

    from gerrytools.plotting import ViolinPlot
    # dist = ViolinPlot(include_legend=False, violinplot_group_width=1.0, violinplot_width_scale=1.0)
    dist = ViolinPlot(include_legend=False, dpi=500)
    
    dist.add_violinplot_datasets(make_boxplot_set(0.00), name="Ensemble", facecolor="alizarin")
    # dist.add_violinplot_datasets(make_boxplot_set(0.05), name="Citizen",  facecolor="#f58518")
    dist.add_violinplot_datasets(make_boxplot_set(0.00), name="Citizen",  facecolor="#f58518")
    dist.add_violinplot_datasets(make_boxplot_set(0.05), name="Plan X",  facecolor="teal!50")
    dist.show()



.. image:: making_plots%20copy_files/making_plots%20copy_20_0.png


.. code:: ipython3

    # dist = ViolinPlot(include_legend=True)
    dist = ViolinPlot(include_legend=False, violinplot_group_width=0.7, violinplot_width_scale=0.8, xlabel="thing $\sigma$", ylabel="yhing", title="My ViolinPlot")
    
    dist.add_violinplot_datasets(
        make_boxplot_set(0.00), 
        name="Default", 
        edgecolor="#ff000022",
        edgewidth=4
    )
    dist.add_violinplot_datasets(make_boxplot_set(0.00), name="Ensemble", facecolor=(1, 0, 0, 0.1), facealpha=0.5)
    dist.add_violinplot_datasets(make_boxplot_set(0.05), name="Citizen",  facecolor="#f58518")
    # dist.add_violinplot_datasets(make_boxplot_set(-0.03), name="Plan X",  face_color="#54a24b")
    dist.add_violinplot_datasets(make_boxplot_set(-0.01), name="Plan X",  facecolor="#54a24b44")
    # dist.add_violinplot_datasets(make_boxplot_set(-0.01), name="Plan X",  facecolor="none")
    # dist.add_violinplot_datasets(make_boxplot_set(0.00), name="Ensemble 2", face_color="purple!50")
    # dist.add_violinplot_datasets(make_boxplot_set(0.00), name="Ensemble 3", face_color="blue!50!red")
    # dist.add_violinplot_datasets(make_boxplot_set(0.00), name="Ensemble 4", face_color="green")
    dist.add_violinplot_datasets(make_boxplot_set(0.00), name="Ensemble 5", facecolor="red!50!blue!67!green!50!white")
    dist.add_violinplot_datasets(make_boxplot_set(0.00), name="Ensemble 6", facecolor="r!10!g!10!b!20")
    # dist.clear_xticks()
    # dist.clear_yticks()
    # dist.set_xaxis_fontsize(12)
    # dist.hide_frame()
...
.. code:: ipython3
    ...
    from gerrytools.plotting import TextArrowStyle
    h.grid = True
    h.add_text_arrow(
        (0.4,2),
        "up",
    ...
    h.add_label_arrow(
        ...
        text="hi",
        arrow_length=5
        # textstyle = AnnotationArrowTextStyle(
        #     fontcolor="black",
        # )
    )
    h.show()
...
.. parsed-literal::
    ...
    /mnt/efs/h/Dropbox/MADLAB/Git_Repos/peter/gerrytools-dev/gerrytools/plotting/data/histogram.py:446: UserWarning: Outline histogram specified with facecolor != 'none'; setting facecolor to 'none'.
      warn(



.. image:: making_plots%20copy_files/making_plots%20copy_22_1.png
...
.. parsed-literal::
    ...
    /mnt/efs/h/Dropbox/MADLAB/Git_Repos/peter/gerrytools-dev/gerrytools/plotting/data/histogram.py:438: UserWarning: Outline histogram specified with edgewidth <= 0; setting edgewidth to 0.8.
      warn(
    /mnt/efs/h/Dropbox/MADLAB/Git_Repos/peter/gerrytools-dev/gerrytools/plotting/data/histogram.py:455: UserWarning: Outline histogram specified with edgecolor 'none'; setting edgecolor to 'black'.
      warn(



.. image:: making_plots%20copy_files/making_plots%20copy_23_1.png
...
.. image:: making_plots%20copy_files/making_plots%20copy_24_0.png
