"""Shared geometry helpers for LaTeX plotting."""
...
def line_segment_through_unit_square(
    slope: float, *, round_to: int = 4
) -> tuple[float, float, float, float]:
    """Compute line endpoints in the unit square for a line through ``(0.5, 0.5)``.

    Args:
        slope (float): Slope of the line.
        round_to (int, optional): Decimal places used to round each coordinate.
            Defaults to ``4``.
